...
PROJECTS := azaroths-kingdom raylib

.PHONY: all clean help $(PROJECTS) 

all: $(PROJECTS)

azaroths-kingdom: raylib
ifneq (,$(azaroths_kingdom_config))
	@echo "==== Building azaroths-kingdom ($(azaroths_kingdom_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f azaroths-kingdom.make config=$(azaroths_kingdom_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f azaroths-kingdom.make clean
